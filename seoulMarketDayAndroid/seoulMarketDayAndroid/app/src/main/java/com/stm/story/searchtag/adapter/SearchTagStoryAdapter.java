...
public class SearchTagStoryAdapter extends RecyclerView.Adapter<SearchTagStoryAdapter.SearchTagStoryViewHolder> implements HashTagHelper.OnHashTagClickListener {
    ...
    public void onBindViewHolder(SearchTagStoryViewHolder holder, int position) {
        ...
        Linkify.addLinks(holder.tv_searchtag_content, Linkify.WEB_URLS);
    ...
    public void setSearchTagFileAdapterItem(SearchTagStoryViewHolder holder, List<File> files) {
        ...
        holder.cpi_searchtag.setViewPager(holder.vp_searchtag_file);
        holder.ll_searchtag_position.bringToFront();
    }
    ...
    public void goneMedia(SearchTagStoryViewHolder holder) {
        holder.fl_searchtag_file.setVisibility(View.GONE);
    }
